...
const testimonials = [
  {
    ...
    avatar: "SM",
    rating: 5,
    text: "BookFarm made our wedding venue search so easy! We found the perfect rustic barn and the catering vendor through the platform. Everything was seamless.",
    location: "Austin, TX",
  },
  {
    id: 2,
    ...
    avatar: "JA",
    rating: 5,
    text: "Our company needed a unique venue for our annual retreat. The booking process was straightforward and the venue exceeded all expectations.",
  ...
  },
  {
    ...
    avatar: "DC",
    rating: 5,
    text: "Threw my wife's 40th birthday at a gorgeous farmhouse we found here. The host was wonderful and the memories are priceless!",
