              ...
              {filteredVendors.map((vendor, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <Link to={`/services/${vendor.id}`} className="block h-full">
                      <div className="group bg-card rounded-2xl border border-border p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
                        {/* Header */}
                        ...
                        <div className="flex-1 flex flex-col">
                          ...
                          {/* Tags - fixed min-height to prevent layout shift */}
